...
async def gen(prompt, dirr="photo", etap="Etap 1", num_images=1, progress_callback=None):
    ...
    clear_directory(etap_dir)  # Clear directory before saving new images
